...
<div class="wrapper" style="background-color: #fff">
    ...
    <header class="main-header"  >
        ...
        <nav class="navbar navbar-static-top" style="background-color: #fff" role="navigation">
            ...
            <a href="{{route('anasayfa')}}"><img height="100px;" width="238px;" style="" src="/img/more-payroll-bordrolama-tesvik-danismanligi.png" alt=""></a>
            <!-- Navbar Right Menu -->
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class=""align="center" >
                                    <a href="{{route('logout')}}" class="btn btn-default "style="">Çıkış Yap</a>
                                </div>
                            </li>
                        </ul>
                    </li>
            ...
            <ul class="sidebar-menu" data-widget="tree" style="margin-top: 0px;">
                ...
                <li class=" treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{route('customer.index')}}"><i class="fa fa-circle-o"></i> Müşteri Ekle</a></li>
                        @if(Auth::user()->id==5 || Auth::user()->id==6 ||Auth::user()->id==1||Auth::user()->id==21 ||Auth::user()->id==4 ||Auth::user()->id==32 )
                        <li><a href="{{route('email.index')}}"><i class="fa fa-circle-o"></i> Müşteri Sicil Kart</a></li>
                ...
                <li><a href="{{route('offer_create')}}"><i class="fa fa-users"> </i>Teklif Ver</a></li>
                <li><a href="{{route('offer.index')}}"><i class="fa fa-users"> </i>Teklif Tablom</a></li>
                    @if(Auth::user()->id==5 || Auth::user()->id==6 ||Auth::user()->id==1||Auth::user()->id==21 ||Auth::user()->id==4 || Auth::user()->id==10 )
                ...
                <ul class="treeview-menu">
                    @if(Auth::user()->id==5 || Auth::user()->id==6 ||Auth::user()->id==1 || Auth::user()->id==13 )
                    <li><a href="{{route('office.index')}}"><i class="fa fa-users"> </i>Ofis Harcamaları</a></li>
                    <li><a href="{{route('muhasebe.index')}}"><i class="fa fa-users"> </i>Masraflar</a></li>
                    <li><a href="{{route('cos.report.index')}}"><i class="fa fa-users"> </i> Personel Masraf Raporu</a></li>
                    @endif
                <li><a href="{{route('form',['id'=>Auth::user()->id])}}"><i class="fa fa-users"> </i>Masraf Formu</a></li>
                </ul>
                </li>
                    @if(Auth::user()->id==5 || Auth::user()->id==6 ||Auth::user()->id==1 )
                <li class=" treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                            ...
                            <li><a href="{{route('file.index')}}"><i class="fa fa-users"> </i>excell</a></li>
                            <li><a href="{{route('excel.show')}}"><i class="fa fa-users"> </i>Excell Tablo</a></li>
                            <li><a href="{{route('excel.report.get')}}"><i class="fa fa-users"> </i>Faliyet Raporu</a></li>
                ...
                <li class=" treeview">
                    <a href="#">
                        @if(Auth::user()->id==1 || Auth::user()->id==5||Auth::user()->id==11 || Auth::user()->id==10)
                        <i class="fa fa-dashboard"></i> <span>Satışcılar</span>
                            @endif
                    </a>
                    <ul class="treeview-menu">
                        @if(Auth::user()->id==1 || Auth::user()->id==5)
                            <li><a href="{{route('target.index')}}"><i class="fa fa-users"> </i>Satışcı Hedef Bidirimi </a></li>
                        @endif
                            @if(Auth::user()->id==11 || Auth::user()->id==10 || Auth::user()->id==1)
                            <li><a href="{{route('personel.show',['id'=>Auth::user()->id])}}"><i class="fa fa-users"> </i>Satışcı Ekranı </a></li>
                            @endif
