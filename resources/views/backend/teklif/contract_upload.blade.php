    ...
    <section class="content-header">
        <div class="box box-danger">
            ...
            <div class="box-body">
                ...
                <div id="tesvik">
                    <form action="{{route('offer.update',['id'=>$offer->id])}}" method="POST"
                        ...
                        <div class="form-group col-md-5 col-sm-3 col-xs-12">
                            ...
                            <select class="form-control" name="customer_id">
                                ...
                                <option value="{{$offer->customer->id}}">{{$offer->customer->name}}</option>
                        ...
                        <div class="form-group col-md-5 col-sm-3 col-xs-12 col" id="seller_type">
                            ...
                            <select class="form-control" name="Seller">
                                @foreach($sellers as $seller)
                                    <option
                                        <?php if ($offer->target_seller_id == $seller->id) echo 'selected="selected"';?>value="{{$seller->id}}">{{$seller->seller_name}}</option>
                                @endforeach
                            </select>
                        </div>
