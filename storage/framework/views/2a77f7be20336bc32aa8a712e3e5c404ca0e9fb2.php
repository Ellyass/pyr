    ...
    <section class="content-header" >
        <div class="box box-danger"  >
            <div class="box-header with-border" style="background-color: #fff" >
                <h4 style="">Müşteri Güncelle</h4>
            </div>
            <div class="box-body">
                <form action="<?php echo e(route('customer.update',['id'=>$edit->id])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                <div class="form-group">
                    <label  class="control-label col-md-3 col-sm-3 col-xs-12" >Firma Adı <span class="required">*</span></label>
                        <input type="text" name="name"  required="required" class="form-control" value="<?php echo e($edit->name); ?>" >
                </div>

                <div class="form-group" >
                    <label  class="control-label col-md-3 col-sm-3 col-xs-12" >Firma Adress <span class="required">*</span>
                    </label>
                        <input type="text" name="address" value="<?php echo e($edit->address); ?>"  required="required" class="form-control">
                </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class=" form-control " name="status" >
                                <?php $__currentLoopData = config('variables.crm.status'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if($edit->status==$status): ?> selected <?php endif; ?> value="<?php echo e($key); ?>"><?php echo e($status); ?></option>
                    ...
                    <div class="form-group col-md-4" style="margin-left: 350px;">
                        ...
                        <select class="js-example-basic-multiple form-control"  name="customer_type_id[]" multiple="multiple">
                                ...
                                <option
                                    <?php if(in_array($key, $a)): ?> selected <?php endif; ?> value="<?php echo e($key); ?>"><?php echo e($type); ?>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\morepayr\resources\views/backend/customer/customer_edit.blade.php ENDPATH**/ ?>