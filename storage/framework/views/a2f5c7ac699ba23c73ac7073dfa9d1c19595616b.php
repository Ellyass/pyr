...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <section class="content-header" >
        <div class="box box-danger"  >
            ...
            <form action="<?php echo e(route('form.create.post')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
            <div class="box-body">
                <div class="container">
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\morepayr\resources\views/backend/Cos/cost_form.blade.php ENDPATH**/ ?>