                        ...
                        <table id="example1" border="1"  class="table table-bordered table-striped" style="color: #000000;border-bottom-color: #000000;">
                            ...
                            <?php $__currentLoopData = $customer_emails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($email->customer['name']); ?></td>
                                    ...
                                    <td><?php if($email->customer['status'] == 'POTANSİYEL'): ?> <label for="" class="label label-danger"><?php echo e($email->customer['status']); ?></label> <?php else: ?> <label for="" class="label label-success"><?php echo e($email->customer['status']); ?></label> <?php endif; ?> </td>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/morepayroll/public_html/arge/resources/views/backend/customer/customer_email/index.blade.php ENDPATH**/ ?>