        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                ...
                <div id="performans">
                    ...
                    <form action="<?php echo e(route('pdf.performans')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
            ...
            <div id="kvkk">
                ...
                <div id="iys">
                    <form action="<?php echo e(route('pdf.iys')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
            ...
            <!--Kvkk Bitiş-->
            <div id="Egitim">
                <form action="<?php echo e(route('offer.import')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="form-group col-md-5 col-sm-3 col-xs-12" >
                        <label for="exampleInputPassword1">Firma Seciniz</label>
                        <select class="form-control" name="customer_id">
                ...
                <div  id="ikmetrik">
                    <form action="<?php echo e(route('pdf.ikmetrik')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group col-md-5 col-sm-3 col-xs-12" >
                            <label for="exampleInputPassword1">Firma Seciniz</label>
                            <select class="form-control" name="customer_id">
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/morepayroll/public_html/arge/resources/views/backend/teklif/teklif_create.blade.php ENDPATH**/ ?>