                    ...
                    <form action="<?php echo e(route('offer.update',['id'=>$offer->id])); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-5 col-sm-3 col-xs-12 col" id="seller_type">
                            ...
                            <select class="form-control" name="Seller" >
                                ...
                                <option <?php if($offer->target_seller_id==$seller->id) echo 'selected="selected"';?>value="<?php echo e($seller->id); ?>"><?php echo e($seller->seller_name); ?></option>
                ...
                <div id="bodrolama">
                    <form action="<?php echo e(route('offer.update',['id'=>$offer->id])); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-10 col-sm-3 col-xs-12 col" >
                            ...
                            <input type="text" name="offer_amount" class="form-control" value="<?php echo e($offer->offer_amount); ?>">
                        </div>
                ...
                <div id="kvkk">
                    <form action="<?php echo e(route('offer.update',['id'=>$offer->id])); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-5 col-sm-3 col-xs-12 col"  >
                            ...
                            <input type="text" required name="offer_money" class="form-control" value="<?php echo e($offer->offer_money); ?>" >
                        </div>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/morepayroll/public_html/arge/resources/views/backend/teklif/contract_upload.blade.php ENDPATH**/ ?>