    ...
    <section class="content-header">
        <div class="box box-danger">
            ...
            <div class="box-body">
                ...
                <div id="tesvik">
                    <form action="<?php echo e(route('pdf.tesvik')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>

                        <input type="hidden" name="customer_id" value="<?php echo e($offer->customer_id); ?>">
                            ...
                            <div class="form-group col-md-5 col-sm-3 col-xs-12 col" >
                                ...
                                <select class="form-control" name="target_Seller_id" >
                                    <?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option selected value="<?php echo e($seller->id); ?>"><?php echo e($seller->seller_name); ?></option>
               ...
               <div id="bodrolama">
                    ...
                    <form action="<?php echo e(route('pdf.bordrolama')); ?>" method="POST" >
                ...
                <div id="kvkk">
                    <form action="<?php echo e(route('pdf.kvkk')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <div id="danismanlik">
                    <form action="<?php echo e(route('pdf.danismanlik')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <div id="Egitim">
                    <form action="<?php echo e(route('offer.update',['id'=>$offer->id])); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-group col-md-5 col-sm-3 col-xs-12" >
                            <label for="exampleInputPassword1">Firma Seciniz</label>
                            <select class="form-control" name="customer_id">

                                    <option selected value="<?php echo e($offer->customer->id); ?>"><?php echo e($offer->customer->name); ?></option>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/morepayroll/public_html/arge/resources/views/backend/teklif/edit.blade.php ENDPATH**/ ?>